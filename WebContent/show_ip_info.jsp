...
<div id="mainBar"
	...
	var myChart;
		...
		function test()
		{
			...
			var sessionnumber = [1,1,1]; 
			var sessionjumpnumber = [1,1,1];
			var jumprate = [1,1,1];
			$.ajax({url:"/BigData/region/regionList.xhtml",type:"GET",success:function(msg){
				...
				sessionnumber =  msg.sessionNumberData;
				sessionjumpnumber = msg.sessionJumpnumberData;
				jumprate = msg.jumpRateData;
				...
				option = {
						...
						legend : {
							...
							data : [ '地域','地域总数','地域会话总数','地域跳出数','地域跳出率']
						},
						//工具箱，每个图表最多仅有一个工具箱  
						toolbox : {
